...
public class ContextProvidersPanel extends JPanel {
    ...
    private void displayProviderContent(ContextProvider provider) {
        ...
        contentDisplayWorker = new SwingWorker<List<Part>, Void>() {
            ...
            protected List<Part> doInBackground() throws Exception {
                return chat.getContentFactory().processProvider(provider);
            }
    ...
    private class ProviderTableModel extends AbstractTableModel {
        private final String[] columnNames = {"Enabled", "Provider", "Position", "Size", "Time (ms)"};
        ...
        public Class<?> getColumnClass(int columnIndex) {
            switch (columnIndex) {
                ...
                case 2: return ContextPosition.class;
                case 3:
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            switch (columnIndex) {
                ...
                case 2: return info.provider.getPosition();
                case 3: return info.sizeInBytes < 0 ? "..." : info.sizeInBytes;
                case 4: return info.timeInMillis < 0 ? "..." : info.timeInMillis;
                default: return null;
            }
        }
