 ...
 * the {@link uno.anahata.gemini.ui.render.editorkit.EditorKitProvider} interface, which allows a host
 * application (like an IDE) to inject its own, more powerful editor kits for rendering code blocks.
 * A {@link uno.anahata.gemini.ui.render.editorkit.DefaultEditorKitProvider} is included for standalone
