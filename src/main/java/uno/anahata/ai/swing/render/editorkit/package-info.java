 ...
 * the {@link uno.anahata.ai.ui.render.editorkit.EditorKitProvider} interface, which allows a host
 * application (like an IDE) to inject its own, more powerful editor kits for rendering code blocks.
 * A {@link uno.anahata.ai.ui.render.editorkit.DefaultEditorKitProvider} is included for standalone
